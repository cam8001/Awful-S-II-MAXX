...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        AwfulQA *thank = [AwfulQA withQuestion:@"Thank the person who made this?" answer:@"You can thank forums user 'OHIO' who worked in collaboration with YOSPOS to make this possible."];
        [_content addObject:thank];
